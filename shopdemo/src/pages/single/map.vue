...
export default {
  ...
  created(){
    ...
    // 导航设定
    let links = [
        {id:1,dev:true,name:'首页',ico:'home',open:false,list:[{id:1.1,name:'首页风格1',path:'/index'},{id:1.2,name:'首页风格2',path:'/index01'}]},
        {id:2,dev:true,name:'商品分类',ico:'category',path:'/category'},

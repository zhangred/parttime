<template>
    <div class="pages pfeedback">
        ...
        <p class="btn gb-bgc" @click="save">立即提交</p>
    </div>
</template>
<style lang="less">
    .pfeedback{
        ...
        .trd{ color: red;}
        .btn{ width: 3.55rem; margin: .3rem auto 0; line-height: .44rem; background: @base; border-radius: .06rem; font-size: .18rem; text-align: center; color: #fff;}
